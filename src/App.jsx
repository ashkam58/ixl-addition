  ...
  math: [
    {
      id: "addition",
      label: "Addition",
      skillsRef: "math_addition",
      blurb: "Add whole numbers, decimals, fractions, and integers.",
      count: "495 skills",
    },
    {
      id: "algebra",
      label: "Algebra",
      blurb: "Equations, inequalities, functions, matrices, expressions.",
      count: "677 skills",
    },
    {
      id: "comparing",
      label: "Comparing",
      blurb: "Order numbers, compare fractions, decimals, and large numbers.",
      count: "262 skills",
    },
    {
      id: "counting",
      label: "Counting",
      blurb: "Early counting, skip-counting, hundred chart, forward/backward.",
      count: "298 skills",
    },
    {
      id: "decimals",
      label: "Decimals",
      blurb: "Place value, operations, powers of ten, conversions.",
      count: "210 skills",
    },
    {
      id: "division",
      label: "Division",
      blurb: "Facts, multi-digit division, remainders, decimal quotients.",
      count: "203 skills",
    },
    {
      id: "estimation",
      label: "Estimation",
      blurb: "Estimate sums, differences, products, quotients, percents.",
      count: "101 skills",
    },
    {
      id: "exponents",
      label: "Exponents & Roots",
      blurb: "Powers, radicals, logarithms, properties.",
      count: "203 skills",
    },
    {
      id: "factfluency",
      label: "Fact Fluency",
      blurb: "Core addition, subtraction, multiplication facts.",
      count: "166 skills",
    },
    {
      id: "fractions",
      label: "Fractions",
      blurb: "Equivalent fractions, operations, mixed numbers, complex fractions.",
      count: "434 skills",
    },
    {
      id: "functions",
      label: "Functions & Equations",
      blurb: "Evaluate, graph, proportional relationships, solving.",
      count: "658 skills",
    },
    {
      id: "geometry",
      label: "Geometry & Spatial",
      blurb: "Area, perimeter, angles, similarity, transformations.",
      count: "869 skills",
    },
    {
      id: "graphs",
      label: "Graphs",
      blurb: "Tables, plots, histograms, best-fit lines, circle graphs.",
      count: "435 skills",
    },
    {
      id: "integers",
      label: "Integers",
      blurb: "Add, subtract, multiply, divide integers; equations.",
      count: "77 skills",
    },
    {
      id: "logic",
      label: "Logic & Reasoning",
      blurb: "Puzzles, conditionals, guess-and-check, number construction.",
      count: "44 skills",
    },
    {
      id: "measurement",
      label: "Measurement",
      blurb: "Units, conversions, length/area/volume, metric/customary.",
      count: "156 skills",
    },
    {
      id: "mixedops",
      label: "Mixed Operations",
      blurb: "Choose the operation, multi-step arithmetic, word problems.",
      count: "313 skills",
    },
    {
      id: "money",
      label: "Money & Consumer Math",
      blurb: "Equivalent amounts, add/subtract money, tips, purchases.",
      count: "141 skills",
    },
    {
      id: "multiplication",
      label: "Multiplication",
      blurb: "Equal groups, multi-digit, fractions/decimals, powers of ten.",
      count: "309 skills",
    },
    {
      id: "numbertheory",
      label: "Number Theory",
      blurb: "Factors, primes, classify numbers, rational/irrational.",
      count: "68 skills",
    },
    {
      id: "patterns",
      label: "Patterns",
      blurb: "Numeric patterns, sequences, evaluate expressions for sequences.",
      count: "135 skills",
    },
    {
      id: "percents",
      label: "Percents",
      blurb: "Percent of number, tax/discount, original price, percent error.",
      count: "69 skills",
    },
    {
      id: "placevalue",
      label: "Place Values",
      blurb: "Digit names, word problems, conversions, decimals.",
      count: "91 skills",
    },
    {
      id: "probability",
      label: "Probability & Statistics",
      blurb: "Simple probability, mean/median/mode, outcomes, word problems.",
      count: "229 skills",
    },
    {
      id: "properties",
      label: "Properties",
      blurb: "Addition/multiplication/division properties, distributive, matrices.",
      count: "101 skills",
    },
    {
      id: "ratios",
      label: "Ratios & Proportions",
      blurb: "Compare ratios, solve proportions, scale drawings.",
      count: "110 skills",
    },
    {
      id: "subtraction",
      label: "Subtraction",
      blurb: "Whole, decimal, fraction subtraction, integers.",
      count: "393 skills",
    },
    {
      id: "time",
      label: "Time",
      blurb: "Time units, add/subtract time, elapsed time problems.",
      count: "52 skills",
    },
    {
      id: "trigonometry",
      label: "Trigonometry",
      blurb: "Pythagorean theorem, trig ratios, laws of sines/cosines.",
      count: "116 skills",
    },
    {
      id: "wordproblems",
      label: "Word Problems",
      blurb: "Operation-focused story problems across grades.",
      count: "611 skills",
    },
  ],
...
export default function App() {
  ...
  const [showDashboard, setShowDashboard] = useState(false); // <-- moved up
  ...
  const handleSaveName = () => {
    if (nameInput.trim()) {
      ...
      setUserName(trimmed);
      localStorage.setItem("additionLabUser", trimmed);
    }
  };
  ...
  }, [selectedGrade, selectedLab, selectedSubject, activeSkills]);

  const selectedSkill =
    activeSkills.find((s) => s.id === selectedSkillId) || activeSkills[0];

  // Trigger ad every 2 minutes for demo purposes
  useEffect(() => {
    ...
    try {
      ...
      if (data?.user) {
        ...
        localStorage.setItem(
          "additionLabUserSub",
          String(Boolean(data.user.subscribed))
        );
      }
    } catch (err) {
        ...
        <main className="app-main">
          <section className="game-panel">
            {currentLabConfig && (
              ...
              >
                {currentLabConfig.label}{" "}
                {currentLabConfig.count
                  ? `• ${currentLabConfig.count}`
                  : ""}{" "}
                {currentLabConfig.blurb
                  ? `• ${currentLabConfig.blurb}`
                  : ""}
              </div>
            )}
        ...
        {showProModal && (
          ...
          >
            ...
            <p className="modal-text">
              This skill is part of the Pro plan. Upgrade to unlock all
              labs, skills, and unlimited practice!
            </p>
            <button className="modal-btn" onClick={handleUpgrade}>
              Get Pro Plan
            </button>
            <button
